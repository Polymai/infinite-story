import { storyLanguageLabel } from "../services/storyService.js";
          ...
          <article class="card story-card">
            <header>
              <div>
                ...
                <span class="muted">${escapeHtml(story.genre)} · ${escapeHtml(storyLanguageLabel(story.language))} · ${escapeHtml(story.status)}</span>
              </div>
